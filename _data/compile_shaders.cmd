...
%GLSL_COMPILER% -V -S rchit %SOURCE_FOLDER%r1_hit.glsl -o %BINARIES_FOLDER%r1_chit.bin

:: any-hit shaders
%GLSL_COMPILER% -V -S rahit -DSHADER_ANY_HIT_VARIATION %SOURCE_FOLDER%r1_hit.glsl -o %BINARIES_FOLDER%r1_ahit.bin
